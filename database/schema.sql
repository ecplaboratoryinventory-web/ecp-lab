...
CREATE TABLE equipment (
  ...
  image_url TEXT,
  status TEXT DEFAULT 'available' CHECK (status IN ('available', 'borrowed', 'damaged')),
...
CREATE TABLE notifications (
  ...
  title TEXT NOT NULL,
  message TEXT,
  type TEXT CHECK (type IN ('borrow_status', 'damage_report', 'system', 'announcement', 'overdue_reminder')),
